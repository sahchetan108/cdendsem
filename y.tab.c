...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_grammar = 8,                    /* grammar  */
  YYSYMBOL_rules = 9,                      /* rules  */
  YYSYMBOL_rule = 10,                      /* rule  */
  YYSYMBOL_11_1 = 11,                      /* $@1  */
  YYSYMBOL_alternatives = 12,              /* alternatives  */
  YYSYMBOL_alternative = 13,               /* alternative  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "ARROW", "OR",
  "SEMICOLON", "$accept", "grammar", "rules", "rule", "$@1",
  "alternatives", "alternative", "symbols", YY_NULLPTR
};
...
yyreduce:
  ...
  case 5: /* $@1: %empty  */
#line 65 "parser.y"
       { strcpy(currentLHS, (yyvsp[0].str)); }
#line 1173 "y.tab.c"
    break;

  case 9: /* alternative: symbols  */
#line 75 "parser.y"
    {
...
#line 1189 "y.tab.c"
  ...
  case 10: /* symbols: ID  */
#line 89 "parser.y"
                    { if (tempRHSCount < MAX_RHS) strcpy(tempRHS[tempRHSCount++], (yyvsp[0].str)); }
#line 1195 "y.tab.c"
    break;

  case 11: /* symbols: symbols ID  */
#line 90 "parser.y"
                    { if (tempRHSCount < MAX_RHS) strcpy(tempRHS[tempRHSCount++], (yyvsp[0].str)); }
#line 1201 "y.tab.c"
    break;
